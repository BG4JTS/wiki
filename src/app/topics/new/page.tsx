...
export default function NewTopicPage() {
 ...
 return (
  <div className="animate-fade-in-up max-w-lg mx-auto">
   ...
   {message && (
    <div className={`p-3 text-sm mb-4 ${message.includes("失败")?"bg-red-100 text-red-600 border-2 border-red-300":"bg-green-100 text-green-600 border-2 border-green-300"}`}>
     {message}
    </div>
   )}
